...
var uiltsC = (function () {
    ...
    function setCss(curEle,attr,value){
        ...
        var reg = /^(height|width|top|bottom|left|right|(margin|padding)(Top|Left|Right|Bottom)?)$/
    ...
    function setGroupCss(curEle,options){
        ...
        options = options||0;//判断opitons值是否存在
        //如果传递进来的不是一个对象类型的值，就不执行方法，（严禁的来说都是要对下面代码要能够执行的前提或者条件进行的检测的）
    ...
    function css(curEle){
        ...
        if(typeof argTwo ==="string"){
            ...
            if(!argThree){
                getCss.apply(curEle,ary);
            }
            setCss.apply(curEle,ary);
        }
        if(argThree.toString()==="[object Object]"){
